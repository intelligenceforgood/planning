...
| Analyst UI | **Streamlit on Cloud Run** behind Identity Platform / IAP; reuse analyst dashboard built in core repo. | Minimal lift to share MVP search, rapid iteration for analysts, easy to secure with Cloud Run + Identity Platform. | Jerry | 15 Nov 2025 |
