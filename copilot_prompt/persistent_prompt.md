...
- Use `i4g bootstrap local reset --report-dir data/reports/bootstrap_local` whenever you need to rebuild local demo data (bundles, OCR outputs, Chroma store, review cases) in one step.
